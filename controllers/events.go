...
func GetEvents(httpContext *gin.Context) {
	query := httpContext.MustGet("reqQuery").(*typings.GetEventsRequestQueryType)
...
func CreateEvent(httpContext *gin.Context) {
	body := httpContext.MustGet("reqBody").(*typings.CreateEventRequestBodyType)
