...
const (
	Events_GetEvents_FullMethodName = "/events.Events/GetEvents"
)
...
type EventsClient interface {
	GetEvents(ctx context.Context, in *InputGetEvents, opts ...grpc.CallOption) (*Event, error)
}
...
func (c *eventsClient) GetEvents(ctx context.Context, in *InputGetEvents, opts ...grpc.CallOption) (*Event, error) {
...
type EventsServer interface {
	GetEvents(context.Context, *InputGetEvents) (*Event, error)
...
func (UnimplementedEventsServer) GetEvents(context.Context, *InputGetEvents) (*Event, error) {
...
func _Events_GetEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventsServer).GetEvents(ctx, req.(*InputGetEvents))
	}
...
var Events_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "grpc/proto/events.proto",
}
